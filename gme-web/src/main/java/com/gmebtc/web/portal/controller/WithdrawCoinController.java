...
public class WithdrawCoinController {
    ...
    @ResponseBody
    public Object withdrawAddressDel (HttpServletRequest request,@RequestParam String payPassword,@RequestParam String currencyId
    ...
    public Object withdrawAddressAdd (HttpServletRequest request,@RequestParam String currencyId,@RequestParam String symbol,
                                      @RequestParam String address,@RequestParam String remark,@RequestParam String payPassword){
        HttpSession session = request.getSession();
        Locale locale = (Locale) session.getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME);
        Map<String,String> map = new HashMap<String,String>();
        ResponseResult result = new ResponseResult();
    ...
    @ResponseBody
    public Object getWithdrawAddress (HttpServletRequest request,@RequestParam String currencyId){
    	HttpSession session = request.getSession();
        Locale locale = (Locale) session.getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME);
        Map<String,String> map = new HashMap<String,String>();
        ResponseResult result = new ResponseResult();
    ...
    * @Description: 查询提币历史记录  （BaseController）
    * @param request
    * @param currencyId
    * @param pageNum
    * @param numPerPage
    ...
    * @return Object
     */
    /*@RequestMapping(value = "/getWithdrawRecordPage")
    @ResponseBody
