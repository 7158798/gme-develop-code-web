...
public final class HttpTookit {
	...
	private static int TIME_OUT = com.gmebtc.web.portal.utils.StringUtil
			.convert2Int(ConfigUtil.get("REQUEST_WAIT_TIME"));
	 ...
	 * @throws IOException
	 */
	public static HttpData doPost(String url, Map<String, String> params, String charset, boolean pretty)
			throws Exception {
		StringBuffer response = new StringBuffer();
		...
		if (params != null) {
			...
			for (Map.Entry<String, String> entry : params.entrySet()) {
				// temp = new NameValuePair(entry.getKey(), new
