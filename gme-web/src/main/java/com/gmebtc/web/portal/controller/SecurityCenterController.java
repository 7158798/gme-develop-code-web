...
public class SecurityCenterController {
    ...
    @ResponseBody
    public Object sendEmail(HttpServletRequest request, @RequestParam String email,@RequestParam String type) {
        HttpSession session = request.getSession();
        Locale locale = (Locale) session.getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME);
        HashMap<String, String> map = new HashMap<>();
        GlobalResult result = new GlobalResult();
    ...
    @ResponseBody
    public Object checkEmailCode (HttpServletRequest request, @RequestParam String email,@RequestParam String emailCode){
    	HttpSession session = request.getSession();
        Locale locale = (Locale) session.getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME);
        HashMap<String, String> map = new HashMap<>();
        GlobalResult result = new GlobalResult();
