...
<html>
	...
	<body class="">
			<div class="L_36">
				...
				<form action="c2cTransRecord.html" method="post">
				<div class="L_42">
					<span>币种</span>
		...
		<script type="text/javascript">
			...
			if ((currentPage + 1) <= totalPage) {
				$("#nextPage").click(function(){
					...
					$("#nextPage").attr("href","c2cTransRecord.html?pageNum="+(currentPage+1)+"&currencyId=" + currencyId + "&operationType=" +
			...
			if ((currentPage - 1) >= 1) {
				$("#prePage").click(function(){
					...
					var startTime = $("#startTime").val();
					var endTime = $("#endTime").val();
					$("#prePage").attr("href","c2cTransRecord.html?pageNum="+(currentPage-1)+"&currencyId=" + currencyId + "&operationType=" +
																	operationType + "&startTime=" + startTime + "&endTime=" + endTime);
				});
			}
		</script>
