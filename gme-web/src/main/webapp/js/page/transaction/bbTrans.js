...
$("#buyButton").click(function(){
	...
	$.ajax({
		type: "POST",
		url: "http://192.168.0.148:8081/gme-web/api/v1/coin/bbBuySell.json",
		dataType: "json",
...
function currencyTransRecord(type){
	...
	$.ajax({
		type: "POST",
		url: "http://192.168.0.148:8081/gme-web/api/v1/coin/transRecord.json",
		dataType: "json",
...
function entrustRecord(type){
	...
	$.ajax({
		type: "GET",
		url: "http://192.168.0.148:8081/gme-web/api/v1/coin/entrustRecord.json",
		dataType: "json",
		data: "pairId=" + pairId + "&type=" + type,
		success: function(data){
			if (data.code == 200) {
					...
					if ($(this).children().eq(-2).children().eq(-1).text() == "详情") {
						$(this).children().eq(-2).children().eq(-1).click(function(){
							if ($(this).attr("testStyle") == "testStyle") {
								...
								$.ajax({
									type: "POST",
									url: "http://192.168.0.148:8081/gme-web/api/v1/coin/queryDetial.json",
									dataType: "json",
...
function realTimeTradeRecord(){
	...
	$.ajax({
		type: "GET",
		url: "http://192.168.0.148:8081/gme-web/api/v1/coin/realTimeTradeRecord.json",
		dataType: "json",
		data: "pairId=" + pairId,
		success: function(data){
			if (data.code == 200) {
...
function buySellOrder(){
	...
	$.ajax({
		type: "GET",
		url: "http://192.168.0.148:8081/gme-web/api/v1/coin/buySellOrders.json",
		dataType: "json",
		data: "pairId=" + pairId,
		success: function(data){
			if (data.code == 200) {
...
function indexx() {
	var url = "http://192.168.0.148:8081/gme-web/api/v1/kline/indexTicker.json";
...
function xr(obj) {
	...
	$("#pairArea tr:not(:first)").children().each(function(){
		$(this).click(function(){
			...
			window.location.href="http://192.168.0.148:8081/gme-web/bbTrans.html?symbol="+symbol+"&pairId=" + pairId;
		});
	});
